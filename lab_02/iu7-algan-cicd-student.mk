...
ready/report.pdf: report/report.pdf
	...
	bash ./compress_report.sh report/report.pdf > /dev/null 2>&1
	bash ./compress_report.sh report/images/AA2_1.pdf > /dev/null 2>&1
	bash ./compress_report.sh report/images/AA2_2.pdf > /dev/null 2>&1
